...
locals {
  ...
  version_mismatched = length(local.vesrion_mismatched_resources) > 0
  ...
  device_names = local.version_mismatched != null ? [for k,v in local.vesrion_mismatched_resources : k ] : []

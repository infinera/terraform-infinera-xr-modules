...
resource "xrcm_dscg" "dscg" {
  ...
  dscgid   = var.hubbandwidth != null ? var.hubbandwidth[each.key].leafdscgid : 0
  rxcdscs   = [] // each.value["leafdscidlist"]
  txcdscs   = var.hubbandwidth != null ? var.hubbandwidth[each.key].leafdscidlist : []
